...
import { ArrowLeft, Calendar, ChevronDown, Search, Truck, AlertTriangle } from "lucide-react";
...
                <Truck size={20} />
              </div>
              <h1 className="text-lg sm:text-xl font-bold text-slate-900 dark:text-white tracking-tight">Filo Günlük KM Analizi</h1>
            </div>
          </div>
          <button 
...
                      <td className="p-3 text-center font-bold bg-indigo-50/30 dark:bg-indigo-950/10 text-indigo-600 dark:text-indigo-400">{row.tcg}</td>
