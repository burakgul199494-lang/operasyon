...
import { ArrowLeft, ChevronDown, Calendar, Truck, Package, Zap, Key, Box } from "lucide-react";
...
const PersonnelQuantitiesPage = ({ allData, unitInfo, quantitiesData, onBack }) => {
    ...
    // Birime ait araç bilgisi
    const currentVehicles = unitInfo ? unitInfo[selectedUnit] : null;

    // Hacim (Gelen-Giden) bilgisi için allData
    ...
    // Pivot Tablo Hazırlığı ve Toplamlar
    ...
    return (
        <div className="pb-24 bg-slate-50 dark:bg-slate-900 min-h-screen transition-colors duration-300">
            {/* ÜST HEADER (UnitDetail.js tarzı) */}
            ...
            <div className="p-4 space-y-4">
                ...
                {/* 3. PARÇABAŞI VE PERSONEL ADET KARTLARI */}
                <div className="mb-4">
